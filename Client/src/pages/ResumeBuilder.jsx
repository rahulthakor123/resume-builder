...
import { ArrowLeftIcon, FolderIcon, GraduationCap, User , FileText, Briefcase, Sparkles, ChevronLeft, ChevronRight, Share2Icon, EyeIcon, EyeOffIcon, DownloadIcon } from "lucide-react"
import PersonalInfoForm from "../components/PersonalInfoForm"
import ResumePreview from "../components/ResumePreview"
import TemplateSelector from "../components/TemplateSelector"
import ColorPicker from "../components/ColorPicker"
import ProfessionalSummaryForm from "../components/ProfesionalSummaryForm"
...
const ResumeBuilder = () => {
  ...
  const [ activeSectionIndex, setActveSectionIndex ] =useState(0)
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="flex justify-between items-center mb-6 border-b
            border-gray-300 py-1">
              ...
              <div className="flex items-center">
                ...
                {activeSectionIndex !== 0 && (
                  <button onClick={()=> setActveSectionIndex((prevIndex)=>
            ...
            <button onClick={()=> {toast.promise(saveResume, {loading: 'Saving...,success: "saved successfully,error: "Failed to save'})}}
             className="bg-gradient-to-br from-green-100 to-green-200
            ring-green-300 text-green-600 ring hover:ring-green-400
            transition-all rouded-md px-6 py-2 mt-6 text-sm">
              Save Changes
            </button>
            </div>
          </div>
               ...
               justify-end gap-2">
                {resumeData.public && (
                  <button onClick={handleShare} className="flex items-center p-2 px-4 gap-2 text-xs
                   ...
                   ronded-lg ring-blue-300 hover:ring transition-colors">
                ...
                <button   onClick={changeResumeVisibility} className="flex items-center p-2 px-4 gap-2 text-xs
                 ...
                 ronded-lg ring-green-300 hover:ring transition-colors">
