...
console.log("Extracted Text JSON:", JSON.stringify(resumeText));
console.log("Extracted Text:", resumeText);
  ...
  return (
     ...
     <p className="text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden">Welcome, Rahul</p>
                  ...
                  showUploadResume && (
                   ...
                   <div onClick={e => e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
                    ...
                    <div>
                     ...
                     border group text-slate-400 border-slate-400 border-dash
                     rounded-md p-4 py-10 my-4 hover:border-green-500
                     hover:text-green-700 cursor-pointer transition-colots">
                        {resume ? 
                        (
                    ...
                    hover:bg-green-700 transition-colors flex items-center justify-center gap-2">
                     {isLoading && <LoaderCircleIcon className="anumate-spin size-4 text-white"/>}
