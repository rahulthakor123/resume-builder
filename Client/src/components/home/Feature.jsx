...
const Feature = () => {
    ...
    return (
        <div id='feature' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Build your resume' description="our streamlined process helps you create a progessional resumein minutes with intelligent AI-powered tools and  features." />
